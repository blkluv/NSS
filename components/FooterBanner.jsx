...
import { staggerContainer, textVariant1, zoomIn } from "../utils/motion";
    ...
    <>
      <section className="footer-banner-section">
        ...
        >
          <Box>
            <Box>
              <motion.div variants={textVariant1(0.5)}>
                <Flex>
                  <Box>
            ...
            <Box>
              <motion.div variants={textVariant1(1.0)}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.div variants={zoomIn(1, 1.2)}>
            <Box className="article-box">
              ...
              <Box className="footer-banner-desc-right">
                <Text className="footer-banner-desc-desc">
                  {footerBanner.desc}
                </Text>
